...
export dashqrgenerator

"""
    dashqrgenerator(;kwargs...)
...
"""
function dashqrgenerator(; kwargs...)
        available_props = Symbol[:id, :data, :framed, :size, :style]
        wild_props = Symbol[]
        return Component("dashqrgenerator", "DashQrGenerator", "dash_qr_manager", available_props, wild_props; kwargs...)
end
